...
Talum datos_autom(Talum alum[], int i)
{
    ...
    Tkey mat;
    char nombre_h[30][10] = {"IVAN", "ALEJANDRO", "JOHAN", "DANIEL", "FRANCISCO", "ISAAC", "ALBERTO", "PABLO", "JAVIER", "HUGO", "ALDO", "ADONIS", "JESUS", 
    "LEONARDO", "MANUEL", "ALVARO", "ADRIAN", "ADAM", "AXEL", "ERICK", "GAEL", "BRUNO", "DYLAN", "LUCAS", "OLIVER", "MARCO", "HUGO", "YAEL", "FELIX", "GERMAN"};
    char nombre_m[30][10] = {"MARIA", "FERNANDA", "MIA", "PAOLA", "CAMILA", "MONSERRAT", "VALERIA", "ALICIA", "SOFIA", "GINA", "AURA", "BRUNA", "FRIDA", 
    "GINEBRA", "JULIETA", "MAGDALENA", "ABRIL", "ALEXA", "ALEJANDRA", "VALENTINA", "MARTINA", "ALEXIA", "AMANDA", "BIANCA", "ELENA", "ESMERALDA", "TERESA", 
    "REBECA", "OLIVIA", "DAFNE"};
    char apellidos[30][15] = {"MARTINEZ", "SANCHEZ", "HERNANDEZ", "PEREZ", "RODRIGUEZ", "LOPEZ", "GARCIA", "RUIZ", "COTA", "JUAREZ", "ALVAREZ", "ANDRADE", 
    "BENITEZ", "CASTILLO", "CASTRO", "CONTRERAS", "DEL TORO", "DE LA FUENTE", "DIAZ", "DUARTE", "ESPINOZA", "FERNANDEZ", "FLORES", "MEJIA", "MORA", 
    "PINEDA", "QUISPE", "ROJAS", "SILVA", "VERA"};
...
Talum datos_autom_inac(Talum alum[], int i)
{
    ...
    int j, edad, ap_pat, ap_mat, nombre, genero;
    Tkey mat;
    char nombre_h[30][10] = {"IVAN", "ALEJANDRO", "JOHAN", "DANIEL", "FRANCISCO", "ISAAC", "ALBERTO", "PABLO", "JAVIER", "HUGO", "ALDO", "ADONIS", 
    "JESUS", "LEONARDO", "MANUEL", "ALVARO", "ADRIAN", "ADAM", "AXEL", "ERICK", "GAEL", "BRUNO", "DYLAN", "LUCAS", "OLIVER", "MARCO", "HUGO", "YAEL",
     "FELIX", "GERMAN"};
    char nombre_m[30][10] = {"MARIA", "FERNANDA", "MIA", "PAOLA", "CAMILA", "MONSERRAT", "VALERIA", "ALICIA", "SOFIA", "GINA", "AURA", "BRUNA", "FRIDA", 
    "GINEBRA", "JULIETA", "MAGDALENA", "ABRIL", "ALEXA", "ALEJANDRA", "VALENTINA", "MARTINA", "ALEXIA", "AMANDA", "BIANCA", "ELENA", "ESMERALDA", 
    "TERESA", "REBECA", "OLIVIA", "DAFNE"};
    char apellidos[30][15] = {"MARTINEZ", "SANCHEZ", "HERNANDEZ", "PEREZ", "RODRIGUEZ", "LOPEZ", "GARCIA", "RUIZ", "COTA", "JUAREZ", "ALVAREZ", 
    "ANDRADE", "BENITEZ", "CASTILLO", "CASTRO", "CONTRERAS", "DEL TORO", "DE LA FUENTE", "DIAZ", "DUARTE", "ESPINOZA", "FERNANDEZ", "FLORES", 
    "MEJIA", "MORA", "PINEDA", "QUISPE", "ROJAS", "SILVA", "VERA"};
